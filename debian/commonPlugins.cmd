#- All .template files below are referenced by relative path
#- Set DB file search path like:
#-   epicsEnvSet("EPICS_DB_INCLUDE_PATH", "../../db:/some/other/dir")
...
#dbLoadRecords("sseqRecord.db", "P=$(PREFIX), S=AcquireSequence")
